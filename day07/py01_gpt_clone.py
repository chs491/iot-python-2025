...
from tkinter.messagebox import * # 모듈 밑에 있는 모듈을 from tkinter import *로 가져올 수 없다.
...
# 6. 제미나이 API용 구성
genai.configure(api_key='AIzaSyDUXwChZMSgUw5UTpK2GlwMLiE1CNli2M8') # 신청한 API키 
...
# 12. 아이콘 변경
# ./image/경로는 삭제
# root.iconbitmap('airplane.ico') # pyinstaller로 설치할 때 해당폴더에 복사하고
...
#11. 프로그램 종료버튼(x)를 누르면 종료 메시지 확인후 종료
